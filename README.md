Disclaimer: This was created as part of a learning exercise, as a source to use PowerShell. Yes, Robocopy exist and can do a much better job than this alternative. Again, it was just an exercise. 
